...
@TeleOp(name="Blue Tele middle", group="Blue ILT")
public class ILTBlue extends NextFTCOpMode {
...
//    }
    ...
    public void onInit() {
       ...
       // clanka.setStartingPose(new Pose(40, 79.500, Math.toRadians(143)));
        clanka.setStartingPose(new Pose(72, 72, Math.toRadians(143)));
