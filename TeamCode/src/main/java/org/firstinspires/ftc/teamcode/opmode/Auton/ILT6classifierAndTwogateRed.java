...
@Autonomous(name = "Red 6 Classifier 2 Gate", group = "Blue")
public class ILT6classifierAndTwogateRed extends NextFTCOpMode {
    ...
    public void onInit() {
        ...
        Path3 = clanka
                ...
                .addPath(
                        new BezierCurve(
                                new Pose(58.800, 79.000).mirror(),
                                new Pose(15.000, 60.000).mirror(),
                                new Pose(10, 63.170).mirror()
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(shootAngle), Math.toRadians(33))
                .build();
        Path4 = clanka
                .pathBuilder()
                .addPath(
                ...
                .setLinearHeadingInterpolation(Math.toRadians(33), Math.toRadians(shootAngle))
                .build();
