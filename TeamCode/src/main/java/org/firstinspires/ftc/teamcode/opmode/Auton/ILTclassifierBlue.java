...
//                new FollowPath(Path3)
    ...
    public void onInit() {
        ...
        Path2 = clanka
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(20.800, 57.800), new Pose(58.800, 79.000))
                )
        ...
        Path3 = clanka
                ...
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(11.000, 50.400),
                                new Pose(20.600, 67.000)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(143), Math.toRadians(113))
                .build();
    }
